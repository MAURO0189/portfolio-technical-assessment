...
export interface ApiPageContentPageContent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    page_key: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProjectTestProjectTest extends Struct.CollectionTypeSchema {
  collectionName: 'project_tests';
  info: {
    displayName: 'ProjectTest';
    pluralName: 'project-tests';
    singularName: 'project-test';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::project-test.project-test': ApiProjectTestProjectTest;
